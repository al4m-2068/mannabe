...
export default function Home(){
    return(
        <section className="px-10.5 py-8 flex flex-col justify-end items-center h-screen">
            <div>
                <img src="/images/learning-together.jpg" alt="books" className="bg-cover w-full"/>
            </div>
